...
class Welcome():
    def __init__(self, master):
        ...
        Label(master, text="Welcome To Wages Calculator GUI", fg="red", font=("bold", 10), anchor='w').place(x=100,
                                                                                                             y=50)
...
class Polution():
    def __init__(self, master):
        ...
        Label(master, text="Welcome To Wages Calculator GUI", fg="red", font=("bold", 10), anchor='w').grid(row=0,
                                                                                                            column=2)

        Label(master, text="Enter your Salary per hour", fg="red", font=("bold", 10), anchor='w').grid(row=3, column=0)

        Label(master, text="Enter the number of hours worked ", fg="red", width=20, font=("bold", 10), anchor='w').grid(
            row=4, column=0)
